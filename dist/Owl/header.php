          ...
          <ul>
            ...
            <li class="search-field">
              <form method="get" id="searchform" class="searchform" action="/"> <input type="text" name="s" id="s"
                value="site search..."
                onblur="if(this.value=='') this.value='site search...'; this.className='';"
                onfocus="if(this.value=='site search...') this.value='';  this.className='act';">
              <input type="submit" value="Send" class="searchform__submit" />
            </form>
            </li>
          </ul>
